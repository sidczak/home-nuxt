...
.blob
    <svg viewBox="0 0 800 500" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="100%" id="blobSvg">
      <g transform="translate(143.58179473876953, 25.767372131347656)">
        <defs>
          <clipPath id="shape">
            <path fill="#d1d8e0">
                animate(
        ...
        <image x="0" y="0" width="100%" height="100%" clip-path="url(#shape)" xlink:href="https://naukawpolsce.pl/sites/default/files/styles/strona_glowna_slider_750x420/public/201904/32927972_32927275.jpg?itok=BKlstTWu" preserveAspectRatio="none"></image>
      </g>
    </svg>
</template>
<script>
